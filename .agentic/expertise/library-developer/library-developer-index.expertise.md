...
- Prompts: "add a CLI flag", "change the init command", "fix list output", "add a new command", "update comments CLI", "blockages command bug", "next command", "push/pull commands"
...
- Prompts: "create an issue", "update issue fields", "issue event format", "computeState", "replay events", "change how issues are stored"
...
- Prompts: "parent-child issues", "hierarchy validation", "status cascade", "upward promotion", "close a parent issue", "reparenting", "change status order"
...
- Prompts: "add a blockage", "resolve blockage", "cycle detection", "impact score", "blocked issues", "auto-resolve blockages", "batch blockages"
...
- Prompts: "next command", "recommend next issue", "change next algorithm", "next for a user", "next should consider X"
...
- Prompts: "user registration", "token validation", "auth mode", "revoke user", "regenerate token", "change auth behavior"
...
- Prompts: "add a comment", "update comment", "delete comment", "mention a user", "@mention", "comment event format"
...
- Prompts: "push data", "pull data", "worktree setup", "orphan branch", "git sync", "init with git", "branch configuration"
...
- Prompts: "custom branch name", "--branch flag", "configurable branch", "normalize branch name", "pointer file"
...
- Prompts: "find tracker dir", "resolveTrackerDir", "walk-up discovery", "change how dirs are found", "pointer file resolution"
...
- Prompts: "add error code", "change error message", "exit code", "AgentrackError", "error format"
...
- Prompts: "build the package", "change build output", "tsup config", "publish", "package.json exports", "CJS/ESM dual output"
...
- Prompts: "write a test", "test helper", "test structure", "test coverage", "e2e test", "mock tracker"
...
- Prompts: "what was decided about X spec", "spec review findings", "configurable branch design", "next todo-only", "cap upward promotion"
...
- Prompts: "how events work", "add a new event type", "event sourcing conventions", "replay pattern"
...
- Prompts: "API return type", "discriminated union result", "add a new API method", "result type pattern"
...
- Prompts: "atomic write", "file write pattern", "safe file operations"
...
- Prompts: "index manager", "sorted index", "binary search", "childrenOf map", "fast lookups"
...
- Prompts: "add a new CLI command", "CLI command pattern", "command registration", "runner.ts"
...
- Prompts: "when was X implemented", "what changed in phase N", "implementation history"
...
- Prompts: "how to add a new CLI command"
...
- Prompts: "how to add a new Tracker method"
...
- Prompts: "how to add a new event type"
